...
API_KEY = 'AIzaSyA7XzASKApWsGPqOSm2HUW8f1U4vyfk5c0'
...
TABLE_ID = '1PPuQA-k-X9TTCgjwgDt7fMXnPm7bdt7H8IlMecdi'

# This is the default columns for the query
query_cols = ['Club']
query_values = ['Midfielder - Man City'] #Change to be the value(s) you're querying in the column you've specified
